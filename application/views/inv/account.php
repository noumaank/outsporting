...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="form-group pull-right"><label for="logout" ><a href="<?php echo base_url(); ?>invLogout">Logout</a></label>
            </div>
            <h2>User Account</h2>
            <h3>Welcome <?php echo $inv['name']; ?>!</h3>
            <div class="account-info">
                <p><b>Name: </b><?php echo $inv['name']; ?></p>
                <p><b>Email: </b><?php echo $inv['email']; ?></p>
                <p><b>Phone: </b><?php echo $inv['phone']; ?></p>
                <p><b>Gender: </b><?php echo $inv['gender']; ?></p>
            </div>
